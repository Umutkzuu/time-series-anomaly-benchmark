...
def main():
    ...
    print(f"Train anomali orani: {anomali_orani:.4f}")
    print(f"Normal/Anomali orani: {(1-anomali_orani)/(anomali_orani+1e-9):.1f}:1")
    print(f"Train anomali sayisi: {(y_train == 1).sum()} / {len(y_train)}\n")
